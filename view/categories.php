...
<div class="container">
    ...
    <div class="toolbar">
        <div class="showing-text">
            Showing <?= count($products) > 0 ? $offset + 1 : 0 ?>-<?= min($offset + count($products), $totalItems) ?> of
            <?= $totalItems ?> Items
        </div>
        <div class="actions">
            ...
            <?php foreach ($products as $product): ?>
                ...
                <div class="product-card">
                    <div class="product-img-wrapper" data-images='<?= json_encode($images); ?>'>
                        <img src="/assets/uploads/products/<?= htmlspecialchars($firstImage); ?>"
                    ...
                    <div class="product-footer">
                        ...
                        <form method="POST" action="/cart">
                            ...
                            <input type="hidden" name="image"
                                value="assets/uploads/products/<?= htmlspecialchars($firstImage); ?>">
