...
<body>
  ...
  <main class="admin-main">
    ...
    <section class="stats">
      ...
      <div class="stat">
        <div class="num"><?= (int) $stats['farmers'] ?></div>
        <div class="label">Farmers</div>
      </div>
      <div class="stat">
        <div class="num"><?= (int) $stats['products'] ?></div>
    ...
    <section class="panels" style="display: block;">
      ...
      <div class="charts-section">
        ...
        <div class="panel chart-panel pie-chart">
          ...
          <canvas id="categoryPieChart" data-labels='<?= json_encode(array_column($categoryStats, "category_name")) ?>'
