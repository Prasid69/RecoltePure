...
<body>
    ...
    <main class="admin-main">
        ...
        <div class="charts-container"
            style="display: grid; grid-template-columns: 2fr 1fr; gap: 20px; margin-bottom: 30px; align-items: start;">
            ...
            <div class="panel">
                ...
                <div style="height: 300px;">
                    <canvas id="statusPieChart" data-labels='<?= json_encode(array_column($statusStats, 'status')) ?>'
