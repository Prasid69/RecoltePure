                    ...
                    <tr>
                        <td>
                            <div class="user-info">
                                ...
                                <small><i class="fas fa-map-marker-alt"></i> <?= htmlspecialchars($farmer['address']) ?></small>
                            </div>
                        </td>
                        <<td>
                        ...
                        <td>
                            ...
                            <?php elseif ($farmer['account_status'] === 'Rejected'): ?>
                                <span class="status status-pending" style="background:#fdeaea; color:#e74c3c;">Rejected</span>
                            <?php else: ?>
                        ...
                        <td class="actions">
                            ...
                            <?php if ($farmer['account_status'] === 'Pending'): ?>
                                ...
                                <a href="index.php?page=admin&action=verify_farmer&id=<?= $farmer['farmer_id'] ?>&status=Rejected" class="btn-icon text-danger" title="Reject">
