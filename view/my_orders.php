    ...
    <?php if (empty($orders)): ?>
        <div class="no-orders">
            ...
            <a href="index.php?page=home"
                style="color: #4CAF50; text-decoration: none; margin-top: 10px; display: inline-block;">Start Shopping</a>
        </div>
    <?php else: ?>
                ...
                <?php foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="index.php?page=write_review&order_id=<?php echo $order['order_customer_id']; ?>&delivery_id=<?php echo $order['order_delivery_id']; ?>"
                                class="btn-review">
                                ★ Write Review
                            </a>
