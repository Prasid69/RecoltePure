...
class CartController
{
    ...
    public function checkout()
    {
        ...
        $successUrl = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . "/index.php?page=payment_success";
        $cancelUrl = (isset($_SERVER['HTTPS']) ? "https://" : "http://") . $_SERVER['HTTP_HOST'] . "/cart?error=payment_cancelled";
